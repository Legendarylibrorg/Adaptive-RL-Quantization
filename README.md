# Adaptive local llm Quantization with reinforcement learning using llama.cp--Link: (https://github.com/ggml-org/llama.cpp) (local open-source large language model optimization through reward engineering and learned policy)
