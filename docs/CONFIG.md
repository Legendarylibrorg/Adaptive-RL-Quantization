...
- **`reward_weights.eta_token_latency`**, **`reward_weights.theta_compute_route`**: route-efficiency penalties for slow per-token latency and prompt-normalized compute cost.
